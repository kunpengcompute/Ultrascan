...
hsbench是Ultrascan官方提供的Benchmark性能测试工具，通过hsbench的测试结果能够对比使用KHSEL库前后的性能差异。
...
2. 获取[hsbench规则集](https://cdrdv2.intel.com/v1/dl/getContent/739375)，并解压到`build/hsbench-samples`目录。
