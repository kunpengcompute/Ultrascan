...
**New Features<a name="section7266645154314"></a>**

None

**Modified Features<a name="section16177195184414"></a>**

|Feature|Description|
|--|--|
|KHSEL|Optimized the Ultrascan multi-pattern matching algorithm. Optimized the long string validation on the Rose interpreter backend. Added a configuration item for toggling the short-rule bypass algorithm.|

**Deleted Features<a name="section17862111013445"></a>**
...
|Feature|Description|
|--|--|
|KHSEL|Optimized Flink's replaceAll function in C, improving the performance by two times compared to the replaceAll function implemented in Java. Optimized the Ultrascan short-byte rule matching algorithm based on the new Kunpeng 920 processor model, improving the performance by 20%.|
...
|Feature|Description|
|--|--|
|KHSEL|Added algorithm optimization based on the open-source Ultrascan.|
...
### Documentation<a name="EN-US_TOPIC_0000002547210821"></a>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: left;">Provides guidance on how to install and deploy Ultrascan.</td>
      <td style="text-align: left;">Open-source repository</td>
    </tr>
    <tr>
      <td style="text-align: left;">User Guide</td>
      <td style="text-align: left;">Provides guidance on how to use Ultrascan.</td>
      <td style="text-align: left;">Open-source repository</td>
    </tr>
    <tr>
...
Visit the [open-source repository](https://gitcode.com/boostkit/Ultrascan/tree/master) to view or download required documents.
