...
enum : u32 {
    HAO_ARTIFACT_FLAG_PARTIAL_COVERAGE = 1U << 0,
    HAO_ARTIFACT_FLAG_PARTIAL_L2_CAPACITY = 1U << 1,
    ...
    HAO_INVALID_RULE_INDEX = ~0U,
    HAO_LAYOUT_MAX_SELECTORS = 32U,
    HAO_LAYOUT_HASH_BEXT = 0U,
    HAO_LAYOUT_HASH_DOT = 1U,
    HAO_LAYOUT_DOT_VECTOR_LANES = 4U,
    HAO_ENGINE_ID = 2U,
};
...
enum : u16 {
    HAO_RULE_META_FLAG_NOCASE = 1U << 0,
    HAO_RULE_META_FLAG_NORUNS = 1U << 1,
};

enum : u32 {
    HAO_RULE_PLAN_FLAG_KEY_EXPANDED = 1U << 0,
    HAO_RULE_PLAN_FLAG_NORMALIZED = 1U << 2,
    HAO_RULE_PLAN_FLAG_HAS_SUPPLEMENTARY_MASK = 1U << 3,
    HAO_RULE_PLAN_FLAG_OVER_AMBIG_LIMIT = 1U << 4,
    HAO_RULE_PLAN_FLAG_MASK_MERGED = 1U << 5,
    HAO_RULE_PLAN_FLAG_MASK_MERGE_FAILED = 1U << 6,
};
